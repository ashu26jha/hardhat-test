...
export const getIncentivePlugin = async (hre: HardhatRuntimeEnvironment) => getSingleton<Incentive>(hre,"Incentive");
export const getVerifierPlugin = async (hre: HardhatRuntimeEnvironment) => getSingleton<Verifier>(hre,"Verifier");
export const getERC20Plugin = async (hre: HardhatRuntimeEnvironment) => getSingleton<Token>(hre,"Token");
